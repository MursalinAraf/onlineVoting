...
<form name='search' action='search.php'>
        <p>
                ...
                <input type="text" name="search" id="search" value="" size="18" maxlength="100" font color="#000000">
...
<h4>Hellow,&nbsp;<?php echo $_SESSION['SESS_NAME'] ;?><br /></h4>
	 ...
	 <link rel="stylesheet" href="datepicker/css/bootstrap.css"/>
	  ...
	  <script src="datepicker/js/main1.js"> </script>
	  ...
	  Result of Election On: <input class="datepicker" type="text" name="date">
